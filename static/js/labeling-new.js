...
function create_card(data){
    ...
    var new_card = data.label ?
                        ...
                        <div class="card-footer">
                            <a href="{{ url_for('function', a='somevalue', b='anothervalue') }}" class="btn btn-danger xDeleteButtonClass"  id="${data.label}-deleteLabelButton-${data.index}" data-label="${data.label ? data.label : ""}" project_id="${data.project_id ? data.project_id : ""}">Delete</a> <small> Delete all images & labels</small>
                        </div>
                    </div>`  : ""
