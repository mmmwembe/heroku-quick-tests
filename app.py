...
def atagDelete(): 
    ...
    return render_template('labeling-new.html', a=a, b=b, lat_lng ={a: a, b: b} , active_project_result = active_project_result, active_project_id = active_project_id, active_label = active_label)
