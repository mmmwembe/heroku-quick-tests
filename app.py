...
def add_label_records_x():
    ...
    if request.method =='POST':
        ...
        images_norm_data_label_map = request.form['images_norm_data_label_map']
        labelled_images_string = request.form['labelled_images_array']
        canvas_json = json.loads(request.form['original_image_label_jsons'])
    ...
    return jsonify(user_id = user_id, project_id = project_id, active_label = active_label, active_project_result = active_project_result, canvas_json = canvas_json)
