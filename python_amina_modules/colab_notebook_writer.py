...
def create_object_detection_colab_notebook(data, user_id):
    ...
    nb.cells.append(nbf.v4.new_code_cell('\n'.join(
        ['# Install Tflite Model Maker',
         ...
         '# Change version of PyYAML to 5.1. This avoids problems with the object_detector.DataLoader.from_csv',
    ...
    nb.cells.append(nbf.v4.new_code_cell('\n'.join(['spec = model_spec.get("efficientdet_lite2")'])))   
    
    nb.cells.append(nbf.v4.new_markdown_cell('\n'.join(['4) Data - Upload and Split Data Images']))) 
